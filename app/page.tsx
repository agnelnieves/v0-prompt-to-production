...
const imgKurzoLogo = "https://www.figma.com/api/mcp/asset/417e0f34-dfa6-48a4-8007-77ef188b7956"
const imgGailLogo1 = "https://www.figma.com/api/mcp/asset/2127611d-591d-4194-a270-ecec060e1800"
const imgGailLogo2 = "https://www.figma.com/api/mcp/asset/4b8b69dc-3d20-4096-8db1-67ce05c3065d"
    ...
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
        ...
        <div className="mx-auto max-w-[1400px] px-6 lg:px-0 py-8 lg:py-[49px]">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-[18px]">
              <img src={imgV0Logo} alt="v0" className="h-[24px] w-[50px]" />
              <span className="font-mono text-[12px] text-[#737373] tracking-[2.4px] [text-shadow:0px_0px_4px_black]">
                IRL - MIAMI
              </span>
            </div>
            <div className="flex items-center gap-[18px]">
              <button className="bg-white text-[#0f172a] px-6 py-3 rounded-full text-[16px] font-medium leading-[24px] hover:bg-gray-100 transition-colors">
                Sign Up
              </button>
              <button className="bg-black text-white px-6 py-3 rounded-full text-[16px] font-medium leading-[24px] border border-white/30 hover:bg-white/10 transition-colors">
                View on Luma
              </button>
            </div>
          </div>
      ...
      <section className="relative h-[948px] flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-[1383px] px-6 lg:px-0 flex flex-col gap-[30px]">
          ...
          <div className="flex gap-[44px] px-0 lg:px-5">
            <div className="flex flex-col gap-4">
              <p className="font-mono text-[14px] text-[#737373] tracking-[2.8px]">
                WHEN
              </p>
              <p className="font-mono text-[16px] text-white tracking-[-0.64px] font-extralight">
                FEBRUARY 7, 2026
              </p>
            </div>
            <div className="flex flex-col gap-4">
        ...
        {/* Scroll indicator */}
        <div className="absolute bottom-[40px] left-6 lg:left-[172px] px-0 lg:px-5">
          <p className="font-mono text-[14px] text-[#737373] tracking-[2.8px]">
      ...
      <main className="mx-auto max-w-[1400px] bg-black">
        {/* Description Section */}
        <section className="border border-[#262626] min-h-[300px] lg:h-[402px] flex items-center justify-center px-6 lg:px-12 py-12 lg:py-0">
          <p className="text-[22px] lg:text-[30px] font-light leading-[1.5] lg:leading-[46px] tracking-[-0.225px] text-white max-w-[774px]">
        ...
        {/* Agenda Section */}
        <section className="border border-[#262626] border-t-0 px-6 lg:px-16 py-16 lg:py-24 flex flex-col lg:flex-row gap-8 items-start justify-center">
          ...
          <div className="flex flex-col w-full lg:w-auto">
            <AgendaItem number="01" title="Opening" description="For every builder at your event" />
            <AgendaItem number="02" title="Opening" description="For every builder at your event" />
            <AgendaItem number="03" title="Networking" description="Connecting with industry leaders and peers" />
            <AgendaItem number="04" title="Workshops" description="Hands-on sessions to enhance skills" />
            <AgendaItem number="05" title="Closing" description="Summarizing insights and next steps" isLast />
          </div>
        </section>
        ...
        <section className="border border-[#262626] border-t-0 px-6 lg:px-16 py-16 lg:py-24 flex flex-col lg:flex-row gap-8 items-start justify-center">
          ...
          <div className="w-full lg:w-[685px] flex flex-wrap">
            <SponsorCard>
              <img src={imgVercelLogo} alt="Vercel" className="h-[37px] w-auto max-w-[184px]" />
            </SponsorCard>
            <SponsorCard>
            ...
            <SponsorCard>
              <img src={imgUkgLogo} alt="UKG" className="h-[47px] w-auto max-w-[153px]" />
            </SponsorCard>
            <SponsorCard>
              <img src={imgLabMiamiLogo} alt="The Lab Miami" className="h-[93px] w-auto max-w-[177px] object-contain" />
            </SponsorCard>
          </div>
        </section>

        {/* CTA Footer */}
        <section className="border border-[#262626] border-t-0 min-h-[200px] lg:h-[245px] px-6 lg:px-[88px] py-12 flex flex-col lg:flex-row items-center justify-center gap-6 lg:gap-[30px]">
          <h2 className="flex-1 text-[36px] lg:text-[68px] font-semibold leading-[1.1] lg:leading-[72px] tracking-[-0.04em] lg:tracking-[-2.72px] text-white text-center lg:text-left">
            It&apos;s time to ship.
          </h2>
...
function AgendaItem({ 
  ...
  return (
    <div className={`w-full lg:w-[685px] flex items-center gap-[10px] py-6 border-b border-[#262626] ${isLast ? 'border-b-0' : ''}`}>
      <span className="font-mono text-[10px] text-[#737373] tracking-[-0.4px] font-extralight">
        {number}
      </span>
      <span className="text-[18px] lg:text-[20px] text-white leading-[28px]">
        {title}
      </span>
      <div className="flex-1 flex items-center justify-end">
        <span className="text-[12px] lg:text-[14px] text-[#737373] leading-[24px] text-right">
          {description}
        </span>
      </div>
    </div>
...
function ExperienceCard({ 
  ...
  return (
    <div className="w-full sm:w-[calc(50%-0.5px)] lg:w-[342px] border border-[#262626] p-6 lg:p-8 flex flex-col gap-[10px] justify-center -mr-px -mb-px">
      <p className="font-mono text-[10px] text-[#737373] tracking-[-0.4px] font-extralight">
        {number}
      </p>
      <h3 className="text-[20px] lg:text-[24px] text-white leading-[28px]">
        {title}
      </h3>
      <p className="text-[13px] lg:text-[14px] text-[#737373] leading-[24px]">
        {description}
      </p>
    </div>
  )
...
function SponsorCard({ children }: { children: React.ReactNode }) {
  return (
    <div className="w-full sm:w-[calc(50%-0.5px)] lg:w-[342px] h-[140px] lg:h-[173px] border border-[#262626] p-6 lg:p-8 flex flex-col items-center justify-center -mr-px -mb-px">
      {children}
    </div>
  )
}
